...
curl -X POST "http://localhost:11434/api/generate" \
     ...
     -d '{"model": "VyxaFoundation/Vyxa", "prompt": "Write a smart contract"}'
...
License: MIT License
Memory Requirement: 43GB (Quantized), 140GB (Full Precision)
...
Use a VPN or a faster mirror.

🔹 Model runs out of memory?
Try running a lower quantization version (Q4, Q6).
...
📖 [Docs: Vyxa Documentation](https://www.vyxa.org/docs)  
🐦 [Twitter: @VyxaFoundation](https://x.com/vyxaFoundation)
